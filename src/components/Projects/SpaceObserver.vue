<template>
    <span class="projectContent">
        <h1 class="projectTitle">
            Yangwang-1 Space Telescope Data Center
        </h1>
        ...
        <img style="width:70%" src="\ImgThumbNail\observer0.jpg"/>
        <img style="width:70%" src="\ImgThumbNail\observer2.jpg"/>
        <img style="width:70%" src="\ImgThumbNail\observer1.jpg"/>
        <br>
        <p>
            Live Videos:
        </p>
